...
<center><h1 class="text-warning">SHORE INNOVATION</h1></center>
<center><h1 class="text-warning">Categorias</h1></center>
 ...
 <div class="p-4 ">
    ...
    <a href="{{ url('/listar_por_categoria/'.$categoria->id) }}" class="btn btn-primary">Ver lista de Producto</a>
     ...
     @empty  
      <center><h3 class="text-danger bg-white">No existen SubCategorias</h3></center>           
                @endforelse
