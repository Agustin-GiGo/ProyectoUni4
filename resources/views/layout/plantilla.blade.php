...
<body class="fondo">
		<nav class="navbar navbar-expand-lg shadow color-orange">
			<div class="collapse navbar-collapse color-orange">
					 <center><ul class="nav navbar-nav navbar-left color-orange">
					 <a class="link-success" href="{{ url('/')}}"><h4>Lista de Categoria++</h4></a>
